...
https://test.pypi.org/project/memetl-zazulya6303/0.2.3/

5. После этого можно скачать пакет с тестового индекса

```cli
pip install --index-url https://test.pypi.org/simple/ --extra-index-url https://pypi.org/simple/ memetl-zazulya6303==0.2.3
```
